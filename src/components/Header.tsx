...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center border-b-[1px] border-gray-500 h-[89px] xl:pl-40 xl:pr-32 xl:bg-yellow-100  lg:bg-green-100 lg:px-10 md:bg-orange-100 md:px-8   sm:px-16" >
